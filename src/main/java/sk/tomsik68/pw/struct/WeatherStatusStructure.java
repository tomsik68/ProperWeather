...
public class WeatherStatusStructure {
	...
	/*
	 * public WeatherStatusStructure clone() { WeatherStatusStructure clone =
	 * new WeatherStatusStructure(); clone.skyColor = skyColor;
	 * clone.cloudsColor = cloudsColor; clone.fogColor = fogColor; clone.sunSize
	 * = sunSize; clone.moonSize = moonSize; clone.starFrequency =
	 * starFrequency; clone.moonVisible = moonVisible; clone.cloudsVisible =
	 * cloudsVisible; clone.snowing = snowing; clone.thundersAllowed =
	 * thundersAllowed; clone.rain = rain; return clone; }
	 */
