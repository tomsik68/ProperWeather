 ...
 * 
 */
public interface Region extends Comparable<Region>, Iterable<Block>,
		Externalizable {
	/**
	 * 
	 ...
	 * @param paramVector
	 */
	public void spawnEntity(Class<? extends Entity> paramClass,
			Location paramLocation, Vector paramVector);
